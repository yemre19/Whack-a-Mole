...
public:
    ...
    void ciz(SDL_Renderer* renderer, SDL_Texture* arkaplan, SDL_Texture* portalResmi, const vector<SDL_Texture*>& patlamaDokulari, Target& hedef, TTF_Font* font, const vector<SDL_Rect>& portallar);
